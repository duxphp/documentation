...
{var $list = \App\Content\Service\Article::list()}
...
```latte
{var $list = \App\Content\Service\Article::list(['class_id' => 1])}
```
...
```latte
{var $classId = 1}
{var $list = \App\Content\Service\Article::list(['class_id' => $classId])}
```
...
```latte
{var $list = \App\Content\Service\Article::list([], 10)}
```
...
```latte
{var $info = \App\Content\Service\Article::list($id)}
